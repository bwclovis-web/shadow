# Architecture — server layer boundaries

Where server-side code belongs. Keep API routes thin; push business logic into predictable layers.
...
- [Data quality dashboard](../components/Containers/DataQualityDashboard/DOCS.md)
- UI atoms: prefer shared components — see `.cursor/rules/reuse-ui-components.mdc`
