...
export interface ScrapedItem {
  ...
  /**
   * Raw merchant Head/Heart/Base (or MAIN NOTES) text captured at scrape time.
   * Survives noir description rewrite when persisted to DB.
   */
  merchantNotesText?: string
...
export interface PerfumeCsvRecord {
  ...
  baseNotes: string
  detailURL: string
  /** Raw merchant pyramid / MAIN NOTES text for durable refresh (persisted to Perfume.merchantNotesText). */
  merchantNotesText?: string
